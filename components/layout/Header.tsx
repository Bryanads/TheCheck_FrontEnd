...
import { LogoIcon, UserIcon, WaveIcon, CogsIcon, CheckIcon, MenuIcon, XIcon, ChartBarIcon } from '../icons'; // Adicione ChartBarIcon se tiver
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            <div className="hidden md:flex items-center space-x-6">
              {isAuthenticated ? (
                <>
                  <NavLink to="/recommendations" icon={<CheckIcon />}>Recomendações</NavLink>
                  <NavLink to="/forecasts" icon={<ChartBarIcon />}>Previsão</NavLink> {/* <-- LINK ADICIONADO */}
        ...
        {isMenuOpen && isAuthenticated && (
          <div className="md:hidden pb-4">
            <div className="flex flex-col space-y-2 pt-2">
              <MobileNavLink to="/recommendations" onClick={() => handleNavigate('/recommendations')}>Recomendações</MobileNavLink>
              <MobileNavLink to="/forecasts" onClick={() => handleNavigate('/forecasts')}>Previsão</MobileNavLink> {/* <-- LINK ADICIONADO */}
              ...
              <MobileNavLink to="/profile" onClick={() => handleNavigate('/profile')}>Perfil</MobileNavLink>
            </div>
          </div>
        )}
      </nav>
