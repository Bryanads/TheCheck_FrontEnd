...
// Definindo um tipo local para os dados do perfil para garantir a tipagem correta
...
const OnboardingProfilePage: React.FC = () => {
    ...
    // O estado agora é fortemente tipado com OnboardingProfile
    ...
    const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        // Atualiza o estado, mantendo a tipagem correta
        setProfile(prev => ({
            ...prev,
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <h1 className="text-4xl font-bold text-white mb-2">Seu Perfil de Surfista</h1>
            <p className="text-slate-400 mb-8">Passo 1 de 3</p>
