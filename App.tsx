...
const App: React.FC = () => {
  ...
  const noHeaderPaths = ['/loading', '/auth'];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 text-slate-200">
      {/* 4. Renderize o Header apenas se a rota atual NÃO estiver na lista noHeaderPaths */}
      ...
      {/* Opcional: Você também pode esconder o footer nas mesmas páginas */}
